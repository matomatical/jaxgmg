...
from jaxgmg.environments import scattered_cheese
...
def corner(
    ...
    eval_on_level_set = evals.FixedLevelsEvalWithBenchmarkReturns(
        ...
        #benchmark_proxies=eval_on_benchmark_proxies,
    ...
    eval_off_level_set = evals.FixedLevelsEvalWithBenchmarkReturns(
        ...
        #benchmark_proxies=eval_off_benchmark_proxies,
        benchmark_proxies=None,
        env=env,
    )
...
def scatter(
    ...
    wandb_log: bool = True,                # whether to log metrics to wandb
    wandb_entity: str = None,
    wandb_project: str = "proxy_test_scatter",
    wandb_group: str = None,
    wandb_name: str = None,
    # checkpointing
    checkpointing: bool = True,             # keep checkpoints? (default: yes)
    ...
    orig_level_generator = scattered_cheese.LevelGenerator(
        height=env_size,
        width=env_size,
        maze_generator=maze_generator,
        max_cheese_radius=max_cheese_radius,
    ...
    shift_level_generator = scattered_cheese.LevelGenerator(
        height=env_size,
        width=env_size,
        maze_generator=maze_generator,
        max_cheese_radius=max_cheese_radius_shift,
    ...
    if ued == "dr":
        ...
        gen = autocurricula.PrioritisedLevelReplay(
            level_generator=train_level_generator,
            level_metrics = scattered_cheese.LevelMetrics(
                env=env,
                discount_rate=ppo_gamma,
            ),
            level_solver= None,
